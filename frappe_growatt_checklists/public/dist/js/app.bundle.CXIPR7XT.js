"use strict";
(() => {
  // ../frappe_growatt_checklists/frappe_growatt_checklists/public/js/app.bundle.js
  (() => {
    ...
    var frappe_growatt_checklists_utils = {
      async update_related_forms() {
        ...
        wci == null ? void 0 : wci.forEach(async (row) => {
        ...
        wcc == null ? void 0 : wcc.forEach(async (row) => {
        ...
        wcb == null ? void 0 : wcb.forEach(async (row) => {
        ...
        wcs == null ? void 0 : wcs.forEach(async (row) => {
        ...
        wcem == null ? void 0 : wcem.forEach(async (row) => {
        ...
        wcd == null ? void 0 : wcd.forEach(async (row) => {
        ...
        wsp == null ? void 0 : wsp.forEach(async (row) => {
      ...
      fields_handler: async function(form) {
        ...
        const currentStateId = ((_a = Object.values(workflowStates).find((state) => state.name === form.doc["workflow_state"])) == null ? void 0 : _a.id) || 0;
      ...
      trigger_create_sn_into_db: async (form) => {
        ...
        const db_sn = await frappe.db.get_value("Serial No", serial_no, ["serial_no", "item_code", "warehouse", "company", "status", "workflow_state"]).catch((e) => {
          ...
          return null;
        }).then((r) => r == null ? void 0 : r.message);
      ...
      set_service_partner: async function(form) {
        async function decideServicePartner() {
          ...
          return service_partner_companies == null ? void 0 : service_partner_companies.filter((c) => c.name === "Growatt")[0];
        }
        if (form.doc.__islocal)
          return;
    ...
    var get_checklist_doctype = (checklist_tracker_name) => {
      if (checklist_tracker_name === "child_tracker_table")
        return "Checklist of Inverter";
      if (checklist_tracker_name === "child_tracker_table")
        return "Checklist of EV Charger";
      if (checklist_tracker_name === "child_tracker_table")
        return "Checklist of Battery";
      if (checklist_tracker_name === "child_tracker_table")
        return "Checklist of Smart Meter";
      if (checklist_tracker_name === "child_tracker_table")
        return "Checklist of Smart Energy Manager";
      if (checklist_tracker_name === "child_tracker_table")
        return "Checklist of Datalogger";
      return null;
    };
    var GetChecklistTrackerSetup = (checklist_tracker_name) => {
      return async () => {
        ...
        if (!checklist_doctype)
          return;
        if (!((_a = cur_frm.fields_dict) == null ? void 0 : _a[checklist_tracker_name]))
          return;
    ...
    agt.corrections_tracker.table.mirror_child_tracker_table = async () => {
      ...
      if (cur_frm.doc.__islocal)
        return;
      if (!((_a = cur_frm.fields_dict) == null ? void 0 : _a["child_tracker_table"]))
        return;
    ...
    async function runSync(form) {
      ...
      if (!(childTrackerField == null ? void 0 : childTrackerField.$wrapper))
        return;
        ...
        [
          {
            ...
            formatter: (value, doc) => {
              if (!value || !doc["child_tracker_doctype"])
                return String(value || "");
          ...
          },
          {
            ...
            formatter: (value, doc) => {
              ...
              if (doctype && ((_b = (_a = window.frappe) == null ? void 0 : _a.boot) == null ? void 0 : _b.workflows)) {
                try {
...
//# sourceMappingURL=app.bundle.CXIPR7XT.js.map
